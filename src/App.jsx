  ...
  return (
    <div className="container mx-auto px-4 py-8">
      <header className="mb-8 text-center">
        <h1 className="text-3xl font-bold text-blue-600">不動產與社區數據視覺化平台</h1>
        <p className="text-gray-600 mt-2">上傳 CSV 檔案以分析不動產交易與社區數據</p>
      </header>
      ...
      <footer className="mt-12 text-center text-gray-500 text-sm">
        <p>© {new Date().getFullYear()} 不動產與社區數據視覺化平台</p>
      </footer>
    </div>
  );
}
